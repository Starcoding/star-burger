...
SSL сертификат предоставляется Certbot и автоматически продляется каждую неделю.  

## Деплой
Для установки обновлений, необходимо запустить deploy.sh (Который назодится в каталоге /root/).  
Скрипт самостоятельно установит и обновит необходимые библиотеки (как front-end, так и back-end), перезапустит необходимые сервисы и сообщит о деплое на Rollbar.
